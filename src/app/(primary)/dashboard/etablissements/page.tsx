...
import { type Etablissement, EtablissementType } from "@prisma/client";
...
export default function Etablissements() {
  ...
  const [deleteEtablissement, setDeleteEtablissement] =
  ...
  const deleteMutation = api.etablissement.delete.useMutation({
    onSuccess: async () => {
      openPopup();
      setTitle("Etablissement supprimé");
      setMessage("L'établissement a bien été supprimé");
      await refetch();
      setDeleteEtablissement(null);
    },
    onError: () => {
      openPopup();
      setTitle("Erreur");
  ...
  const handleDeleteEtablissement = () => {
    ...
    deleteMutation.mutate({ id: deleteEtablissement.id });
  };
    ...
    <div className="mx-auto flex min-h-screen max-w-screen-2xl flex-col px-4 pb-16">
      <div className="flex-grow">
        <main className="my-0">
          ...
          <Link
            href="/dashboard/etablissements/create"
                  ...
                  render: (id) => (
                    <div className="text-center">
                      <span className="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                        <Link
                          href={`/dashboard/etablissements/fiche/${id?.toString()}`}
                        ...
                        <button
                          ...
                          onClick={() =>
                            setDeleteEtablissement(
                              etablissements?.data.find(
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-sm text-gray-700">
                      ...
                      <strong>
                        {deleteEtablissement.name} -{" "}
                        {deleteEtablissement.codePostal}{" "}
                        {deleteEtablissement.ville}
                      </strong>
                    </p>
                    ...
                    <div className="mt-4 flex gap-2">
                      <button
                        ...
                        onClick={() => setDeleteEtablissement(null)}
                      >
                      ...
                      <button
                        ...
                        onClick={handleDeleteEtablissement}
                      >
